...
@Component({
  selector: 'app-findvenuepage-information',
  templateUrl: './findvenuepage-information.component.html',
  styleUrls: ['./findvenuepage-information.component.css']
})

export class FindvenuepageInformationComponent implements OnInit {
