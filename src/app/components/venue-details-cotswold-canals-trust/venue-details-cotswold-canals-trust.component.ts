...
@Component({
  selector: 'app-venue-details-cotswold-canals-trust',
  templateUrl: './venue-details-cotswold-canals-trust.component.html',
  styleUrls: ['./venue-details-cotswold-canals-trust.component.css']
})
export class VenueDetailsCotswoldCanalsTrustComponent implements OnInit {
