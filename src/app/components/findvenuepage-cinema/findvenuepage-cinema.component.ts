...
@Component({
  selector: 'app-findvenuepage-cinema',
  templateUrl: './findvenuepage-cinema.component.html',
  styleUrls: ['./findvenuepage-cinema.component.css']
})

export class FindvenuepageCinemaComponent implements OnInit {
