...
@Component({
  selector: 'app-findvenuepage-hotels',
  templateUrl: './findvenuepage-hotels.component.html',
  styleUrls: ['./findvenuepage-hotels.component.css']
})

export class FindvenuepageHotelsComponent implements OnInit {
