...
@Component({
  selector: 'app-venue-details-ivy-house',
  templateUrl: './venue-details-ivy-house.component.html',
  styleUrls: ['./venue-details-ivy-house.component.css']
})
export class VenueDetailsIvyHouseComponent implements OnInit {
