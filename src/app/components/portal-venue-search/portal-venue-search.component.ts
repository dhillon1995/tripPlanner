...
@Component({
  selector: 'app-portal-venue-search',
  templateUrl: './portal-venue-search.component.html',
  styleUrls: ['./portal-venue-search.component.css']
})
export class PortalVenueSearchComponent implements OnInit {
