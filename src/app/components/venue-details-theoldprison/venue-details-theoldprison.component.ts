...
@Component({
  selector: 'app-venue-details-theoldprison',
  templateUrl: './venue-details-theoldprison.component.html',
  styleUrls: ['./venue-details-theoldprison.component.css']
})
export class VenueDetailsTheoldprisonComponent implements OnInit {
  showFiller = true;
  value = 'Clear me';
