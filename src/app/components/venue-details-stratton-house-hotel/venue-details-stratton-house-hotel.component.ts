...
@Component({
  selector: 'app-venue-details-stratton-house-hotel',
  templateUrl: './venue-details-stratton-house-hotel.component.html',
  styleUrls: ['./venue-details-stratton-house-hotel.component.css']
})
export class VenueDetailsStrattonHouseHotelComponent implements OnInit {
