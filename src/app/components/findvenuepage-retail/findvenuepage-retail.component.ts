...
@Component({
  selector: 'app-findvenuepage-retail',
  templateUrl: './findvenuepage-retail.component.html',
  styleUrls: ['./findvenuepage-retail.component.css']
})

export class FindvenuepageRetailComponent implements OnInit {
