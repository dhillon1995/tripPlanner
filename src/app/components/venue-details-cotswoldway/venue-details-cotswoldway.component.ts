...
@Component({
  selector: 'app-venue-details-cotswoldway',
  templateUrl: './venue-details-cotswoldway.component.html',
  styleUrls: ['./venue-details-cotswoldway.component.css']
})
export class VenueDetailsCotswoldwayComponent implements OnInit {
