...
@Component({
  selector: 'app-venue-details-corinium-hotel',
  templateUrl: './venue-details-corinium-hotel.component.html',
  styleUrls: ['./venue-details-corinium-hotel.component.css']
})
export class VenueDetailsCoriniumHotelComponent implements OnInit {
