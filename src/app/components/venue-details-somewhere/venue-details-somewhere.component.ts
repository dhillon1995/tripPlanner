...
@Component({
  selector: 'app-venue-details-somewhere',
  templateUrl: './venue-details-somewhere.component.html',
  styleUrls: ['./venue-details-somewhere.component.css']
})
export class VenueDetailsSomewhereComponent implements OnInit {
