...
@Component({
  selector: 'app-venue-details-distillary',
  templateUrl: './venue-details-distillary.component.html',
  styleUrls: ['./venue-details-distillary.component.css']
})
export class VenueDetailsDistillaryComponent implements OnInit {
