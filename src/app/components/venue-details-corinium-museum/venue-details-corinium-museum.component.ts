...
@Component({
  selector: 'app-venue-details-corinium-museum',
  templateUrl: './venue-details-corinium-museum.component.html',
  styleUrls: ['./venue-details-corinium-museum.component.css']
})
export class VenueDetailsCoriniumMuseumComponent implements OnInit {
