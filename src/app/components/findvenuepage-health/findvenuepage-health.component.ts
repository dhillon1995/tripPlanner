...
@Component({
  selector: 'app-findvenuepage-health',
  templateUrl: './findvenuepage-health.component.html',
  styleUrls: ['./findvenuepage-health.component.css']
})

export class FindvenuepageHealthComponent implements OnInit {
