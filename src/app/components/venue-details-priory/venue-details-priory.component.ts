...
@Component({
  selector: 'app-venue-details-priory',
  templateUrl: './venue-details-priory.component.html',
  styleUrls: ['./venue-details-priory.component.css']
})
export class VenueDetailsPrioryComponent implements OnInit {
