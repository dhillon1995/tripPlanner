...
@Component({
  selector: 'app-venue-details-westonbirt-arboretum',
  templateUrl: './venue-details-westonbirt-arboretum.component.html',
  styleUrls: ['./venue-details-westonbirt-arboretum.component.css']
})
export class VenueDetailsWestonbirtArboretumComponent implements OnInit {
