...
@Component({
  selector: 'app-venue-details-sally',
  templateUrl: './venue-details-sally.component.html',
  styleUrls: ['./venue-details-sally.component.css']
})
export class VenueDetailsSallyComponent implements OnInit {
