...
@Component({
  selector: 'app-venue-details-stow-visitor',
  templateUrl: './venue-details-stow-visitor.component.html',
  styleUrls: ['./venue-details-stow-visitor.component.css']
})
export class VenueDetailsStowVisitorComponent implements OnInit {
