...
@Component({
  selector: 'app-venue-details-cineworld-cheltenham',
  templateUrl: './venue-details-cineworld-cheltenham.component.html',
  styleUrls: ['./venue-details-cineworld-cheltenham.component.css']
})
export class VenueDetailsCineworldCheltenhamComponent implements OnInit {
