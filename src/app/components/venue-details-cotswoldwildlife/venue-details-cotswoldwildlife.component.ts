...
@Component({
  selector: 'app-venue-details-cotswoldwildlife',
  templateUrl: './venue-details-cotswoldwildlife.component.html',
  styleUrls: ['./venue-details-cotswoldwildlife.component.css']
})
export class VenueDetailsCotswoldwildlifeComponent implements OnInit {
