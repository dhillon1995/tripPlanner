...
@Component({
  selector: 'app-venue-details-lowermill',
  templateUrl: './venue-details-lowermill.component.html',
  styleUrls: ['./venue-details-lowermill.component.css']
})
export class VenueDetailsLowermillComponent implements OnInit {
