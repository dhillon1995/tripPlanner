...
@Component({
  selector: 'app-venue-details-broadway-tourist-centre',
  templateUrl: './venue-details-broadway-tourist-centre.component.html',
  styleUrls: ['./venue-details-broadway-tourist-centre.component.css']
})
export class VenueDetailsBroadwayTouristCentreComponent implements OnInit {
