...
@Component({
  selector: 'app-mini-cards3',
  templateUrl: './mini-cards3.component.html',
  styleUrls: ['./mini-cards3.component.css']
})
export class MiniCards3Component implements OnInit {
  postData = {
