...
@Component({
  selector: 'app-venue-details-tewkesbury-heritage',
  templateUrl: './venue-details-tewkesbury-heritage.component.html',
  styleUrls: ['./venue-details-tewkesbury-heritage.component.css']
})
export class VenueDetailsTewkesburyHeritageComponent implements OnInit {
