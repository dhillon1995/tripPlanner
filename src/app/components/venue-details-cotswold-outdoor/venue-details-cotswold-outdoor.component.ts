...
@Component({
  selector: 'app-venue-details-cotswold-outdoor',
  templateUrl: './venue-details-cotswold-outdoor.component.html',
  styleUrls: ['./venue-details-cotswold-outdoor.component.css']
})
export class VenueDetailsCotswoldOutdoorComponent implements OnInit {
