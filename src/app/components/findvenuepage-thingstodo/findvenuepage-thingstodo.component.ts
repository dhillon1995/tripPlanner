...
@Component({
  selector: 'app-findvenuepage-thingstodo',
  templateUrl: './findvenuepage-thingstodo.component.html',
  styleUrls: ['./findvenuepage-thingstodo.component.css']
})

export class FindvenuepageThingstodoComponent implements OnInit {
