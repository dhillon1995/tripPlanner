...
@Component({
  selector: 'app-venue-details-steamrailway',
  templateUrl: './venue-details-steamrailway.component.html',
  styleUrls: ['./venue-details-steamrailway.component.css']
})
export class VenueDetailsSteamrailwayComponent implements OnInit {
