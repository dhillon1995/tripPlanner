...
@Component({
  selector: 'app-mini-cards2',
  templateUrl: './mini-cards2.component.html',
  styleUrls: ['./mini-cards2.component.css']
})
export class MiniCards2Component implements OnInit {
  ...
  ngOnInit(): void {
    console.log("mini cards 2", this.venues);
    //console.log(data);
