...
@Component({
  selector: 'app-venue-details-gloucester-tourist-centre',
  templateUrl: './venue-details-gloucester-tourist-centre.component.html',
  styleUrls: ['./venue-details-gloucester-tourist-centre.component.css']
})
export class VenueDetailsGloucesterTouristCentreComponent implements OnInit {
