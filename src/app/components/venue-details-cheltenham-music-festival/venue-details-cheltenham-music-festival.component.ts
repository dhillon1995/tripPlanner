...
@Component({
  selector: 'app-venue-details-cheltenham-music-festival',
  templateUrl: './venue-details-cheltenham-music-festival.component.html',
  styleUrls: ['./venue-details-cheltenham-music-festival.component.css']
})
export class VenueDetailsCheltenhamMusicFestivalComponent implements OnInit {
