...
@Component({
  selector: 'app-venue-details-cathedral',
  templateUrl: './venue-details-cathedral.component.html',
  styleUrls: ['./venue-details-cathedral.component.css']
})
export class VenueDetailsCathedralComponent implements OnInit {
