...
@Component({
  selector: 'app-venue-details-cotswold-hare',
  templateUrl: './venue-details-cotswold-hare.component.html',
  styleUrls: ['./venue-details-cotswold-hare.component.css']
})
export class VenueDetailsCotswoldHareComponent implements OnInit {
