...
@Component({
  selector: 'app-venue-details-gateway',
  templateUrl: './venue-details-gateway.component.html',
  styleUrls: ['./venue-details-gateway.component.css']
})

export class VenueDetailsGatewayComponent implements OnInit {
  showFiller = true;
  value = 'Clear me';
